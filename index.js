...
function createOcean() {
  ...
  return regl({
    frag: glsl`
      ...
      void main () {
        gl_FragColor = vec4(
          noise(vec2(gl_FragCoord.x * 0.01, gl_FragCoord.y * 0.01)),
          noise(vec2(gl_FragCoord.y * 0.01, gl_FragCoord.x * 0.01)),
          noise(vec2(10.0 + gl_FragCoord.x * 0.01, 10.0 + gl_FragCoord.y * 0.01)),
          1);
      }
    `,
    vert: glsl`
